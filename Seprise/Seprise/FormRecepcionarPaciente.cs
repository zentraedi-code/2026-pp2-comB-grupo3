...
namespace Seprise
{
    public partial class FormRecepcionarPaciente : Form
    {
        ...
        private void ConfigurarDataGridView()
        {
            ...
            DataGridViewButtonColumn btnRecepcionar = new DataGridViewButtonColumn();
            btnRecepcionar.Name = "btnRecepcionar";
            btnRecepcionar.Text = "Recepcionar";
            btnRecepcionar.UseColumnTextForButtonValue = true;
            dgvTurnos.Columns.Add(btnRecepcionar);
        }
        ...
        private void dgvTurnos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (columna == "btnRecepcionar")
            {
                dgvTurnos.Rows[e.RowIndex].Cells["Estado"].Value = "RECEPCIONADO";
                MessageBox.Show("Paciente recepcionado exitosamente. El turno está disponible para facturación y cola del médico.", 
